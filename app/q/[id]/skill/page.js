...
import ForkSkillClient from './ForkSkillClient'
...
export default async function ForkSkillPage({ params }) {
        ...
        return (
            <div className="stone-surface" style={{
                ...
                <div style={{ textAlign: 'center', maxWidth: '480px' }}>
                    <p style={{ color: 'var(--brass)', marginBottom: '0.75rem', fontSize: '0.9rem', fontFamily: 'var(--font-mono)' }}>
                        {error}
                    </p>
                    <p style={{ color: 'var(--stone-text-dim)', fontSize: '0.85rem' }}>
                        Skill forks are created by running <code style={{ fontFamily: 'var(--font-mono)', color: 'var(--brass)' }}>/onboard</code> with a Memory Palace agent.
                    </p>
                </div>
            </div>
        )
    ...
    return <ForkSkillClient content={forkSkill} shortId={shortId} />
}
